...
class ForageableViewModel(private val forageableDao: ForageableDao) : ViewModel() {
    ...
    //Cache all Foragables from the database using LiveData
    ...
    fun retrieveForagable(id: Long): LiveData<Forageable> {
    ...
    fun addForageable(
        ...
        addForageable(forageable)
    }

    private fun addForageable(forageable: Forageable) {
    ...
    /**
     * Launching a new coroutine to update a forageable in a non-blocking way
     */
